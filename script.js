...
if (installBtn) {
    ...
    // Comprobar si ya est� instalada o ejecut�ndose como app
    ...
    installBtn.addEventListener('click', async () => {
        if (deferredPrompt) {
            ...
            // Ya no podemos usar el prompt otra vez, as� que lo limpiamos
            deferredPrompt = null;
            // Ocultar el bot�n temporalmente (se volver� a ocultar permanentemente en 'appinstalled')
            installBtn.style.display = 'none';
        }
    });

    window.addEventListener('appinstalled', () => {
        // Limpiar el prompt y ocultar el bot�n permanentemente
        deferredPrompt = null;
        installBtn.style.display = 'none';
